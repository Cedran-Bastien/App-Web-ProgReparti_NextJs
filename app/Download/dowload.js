...
export const Download = () => {
    ...
    return (
        <div className={"p-5 mb-8 "}>
            ...
            <Card title={"Service central"} titleColor={"text-blue-800"} content={<Parameters command={"java Start [port de l'annuaire]"} />} HtmlContent={
                <DownloadHandler filePath={"service_central.zip"} buttonName={"Server"}/>
            }
            />
            <Card title={"Service compute"} titleColor={"text-blue-800"} content={<Parameters command={"java Start [IP service central] [Port de l'annuaire]"} />} HtmlContent={
                <DownloadHandler filePath={"service_calcule.zip"} buttonName={"Calculator"}/>
            }
            />
            <Card title={"Client asking compute"} titleColor={"text-blue-800"} content={<Parameters command={"java Start [IP service central]"} />} HtmlContent={
